...
classifier_net_cfg.sub_batch_size = 32
...
classifier_data_cfg.top_nums = 100

detector_net_cfg.testing = False
detector_net_cfg.batch_size = 32
detector_net_cfg.sub_batch_size = 32
...
detector_data_cfg.names_path = 'data/detector.names'
...
classifier_net_cfg.testing = True
classifier_net_cfg.batch_size = 1
...
detector_net_cfg.testing = True
detector_net_cfg.batch_size = 1
